                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="tables-data.html">afficher la liste des administrateurs</a></li>
                            <li><i class="fa fa-table"></i><a href="tables-data.html">afficher la liste des clients</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-th"></i><a href="tables-data.html">afficher</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="prod.php">ajout</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="afficheprod.php">afficher</a></li>
                        </ul>
                    </li>
...
include "../core/eventC.php";
		...
		if (isset($_GET['id_event'])){
			$event1C=new eventC();
            $result=$event1C->trouverEvent($_GET['id_event']);
			...
			foreach($result as $row){
                ...
                $id_prod=$row['id_prod'];
                $img_event=$row['img_event'];
?>
		<div class="col-md- col-sm-6">
<form method="POST" name="form" onsubmit="return saisie()" action="mod.php">
<div class="form-group">

<caption>Modifier event</caption>

 <label>ID evenement</label>
<input type="text" name="id_event" value="<?PHP echo $id_event ?>" class="form-control"  > 


 <label>Nom evenment</label>
<input type="text" name="nom_event" value="<?PHP echo $nom_event ?>" class="form-control">


 <label>Pourcentage</label>
<input type="number" step="any" name="pourcentage" value="<?PHP echo $pourcentage ?>" class="form-control">


 <label>Date de debut</label>
<input type="date" name="date_debut" value="<?PHP echo $date_debut ?>" class="form-control">


 <label>Date de fin</label>
<input type="date" name="date_fin" value="<?PHP echo $date_fin ?>" class="form-control">


 <label>Nom du produit</label>
<input type="number" name="id_prod" value="<?PHP echo $id_prod ?>" class="form-control">

<label>Nom du produit</label>
<input type="text" name="img_event" value="<?PHP echo $img_event ?>" class="form-control">
<br>


<input type="submit" name="modifier1" value="Modifier" class="btn btn-success btn-lg btn-block">
