...
$categories= $cc->affiche_categorie();
    ...
    if (isset($_GET['ID'])){
        ...
        $result=$prom->recuperer_promotion($id);
        ...
        if(isset($_FILES['image']))
        {
            ...
            $idcat=$_POST['idCat'];
            $promotion1=new promotion($prix,$quantite,$nom, $file_name, $description,intval($idcat));
            $prom->modifier_promotion($promotion1,$_POST['id_ini']);
            echo $_POST['id_ini'];
    ...
    if(isset($_FILES['image']))
    {
        ...
        $description=$_POST['description'];
        $idcat=$_POST['idCat'];
        $promotion1=new promotio($prix,$quantite,$nom, $file_name, $description,intval($idcat));
        $prom->modifier_promotion($promotion1,$_POST['id_ini']);
        echo $_POST['id_ini'];
