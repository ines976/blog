...
if (isset($_GET["ID"])){
    $id =$_GET["ID"];
    $promotions=$pc->Getpromotionbycategory($id);
}
//header('Location: ../.php');
?>
                ...
                <form action="#">
                  ...
                  foreach($categories as $categorie):
                   ?>
                      ...
                      <li>
                      <a href= "category.php?ID=<?= $categorie['IDcat']?>">
                        <?=$categorie["NOMcat"]?>
                        </a>
                      </li> 
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="<?=$baseUrl. $promotion['Image']?>" alt="">
                  ...
                  <div class="card-body">
                    <p><?=$promotion["NOMcat"]?></p>
                    <h4 class="card-product__title"><a  href="#"><?=$promotion["Nom"] ;?></a></h4>
                    <p class="card-product__price"><?=$promotion["Prix"] ;?></p>
                  </div>
                </div>
