				...
				<div class="col-lg-8 posts-list">
					...
					<div class="single-post row">
						<div class="col-lg-3  col-md-3 meta-details">
							<ul class="tags">
								<li><a href="#"><?php echo $article['article'] ?></a></li>
							</ul>
							<div class="user-details row">
								<p class="user-name col-lg-12 col-md-12 col-6"><a href="#"><?php echo $article['id_user'] ?></a> <span class="lnr lnr-user"></span></p>
								<p class="date col-lg-12 col-md-12 col-6"><a href="#"><?php echo $article['date_pub'] ?></a> <span class="lnr lnr-calendar-full"></span></p>
								<p class="view col-lg-12 col-md-12 col-6"><a href="#">Edit</a> <span class="lnr lnr-pencil"></span></p>
								<p class="comments col-lg-12 col-md-12 col-6"><a href="#">Delete</a> <span class="lnr lnr-trash"></span></p>
							</div>
						</div>
